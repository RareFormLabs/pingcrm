<template>
  <div>
    <div
      v-if="$page.props.flashes?.success && show"
    ...
    <div
      v-if="($page.props.flashes?.error || $page.props.errors) && show"
    ...
    >
      <div class="flex items-center">
        ...
        <div
          v-if="$page.props.flashes?.error"
          class="py-4 text-white text-sm font-medium"
        >
          {{ $page.props.flashes?.error }}
        </div>
